  ...
  return (
    ...
    <thead>
      <tr>
        ...
        <th>Items</th>
        <th className="header--order" onClick={() => setOrder('slots')}>Slots</th>
        <th className="header--order" onClick={() => setOrder('nextSlot')}>Next Slot</th>
        <th className="header--order" onClick={() => setOrder('parallel')}>Parallel</th>
      </tr>
    </thead>
    <tbody>
