...
test('Item Stats - Cherry Cheesecake', async (t) => {
  ...
  await t
    .expect(
      screen.findByTestId('dependency-quantity-time-tree-saplings-seeds')
        .textContent,
    )
    .eql('20');
  await t
    .expect(
      screen.findByTestId('dependency-time-bill-tree-saplings-seeds')
        .textContent,
    )
    .eql('20');
  ...
  await t
    .expect(
      screen.findByTestId('dependency-quantity-time-flour-bag-seeds')
        .textContent,
    )
    .eql('20');
  await t
    .expect(
      screen.findByTestId('dependency-time-bill-flour-bag-seeds').textContent,
    )
    .eql('20');

  await t
    .expect(
      screen.findByTestId('dependency-quantity-time-fruit-and-berries-seeds')
        .textContent,
    )
    .eql('20');
  await t
    .expect(
      screen.findByTestId('dependency-time-bill-fruit-and-berries-seeds')
        .textContent,
    )
    .eql('20');
  ...
  await t
    .expect(
      screen.findByTestId('dependency-quantity-time-tree-saplings-shovel')
        .textContent,
    )
    .eql('30');
  await t
    .expect(
      screen.findByTestId('dependency-time-bill-tree-saplings-shovel')
        .textContent,
    )
    .eql('39');
  ...
  await t
    .expect(
      screen.findByTestId(
        'dependency-quantity-time-fruit-and-berries-tree-saplings',
      ).textContent,
    )
    .eql('90');
  await t
    .expect(
      screen.findByTestId(
        'dependency-time-bill-fruit-and-berries-tree-saplings',
      ).textContent,
    )
    .eql('129');
  ...
  await t
    .expect(
      screen.findByTestId('dependency-quantity-time-fruit-and-berries')
        .textContent,
    )
    .eql('90');
  await t
    .expect(
      screen.findByTestId('dependency-time-bill-fruit-and-berries').textContent,
    )
    .eql('219');
});
